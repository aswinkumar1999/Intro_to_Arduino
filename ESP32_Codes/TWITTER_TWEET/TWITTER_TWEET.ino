// Arduino IDE code for standalone ESP32 to update a twitter account using the thingspeak.com API
...
const char* ssid = "Unibic";
const char* password = "biscuits";

// your message
String tweet = "Hello_world_from_esp32";
